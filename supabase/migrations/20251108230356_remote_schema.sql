...
(
    ...
    CONSTRAINT "chat_participants_role_check" CHECK ((("role")::"text" = ANY
...
(
    ...
    CONSTRAINT "chats_type_check" CHECK ((("type")::"text" = ANY
                                          ((ARRAY ['DIRECT'::character varying, 'GROUP'::character varying])::"text"[])))
);
...
(
    ...
    "chat_id"    "uuid"                         NOT NULL,
    CONSTRAINT "messages_status_check" CHECK ((("status")::"text" = ANY
                                               ((ARRAY ['SENT'::character varying, 'DELIVERED'::character varying, 'READ'::character varying])::"text"[])))
);
